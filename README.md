...
| PRD-026 | News-rail quality — stricter filtering + editor-curated candidate sources (Google News top stories, Wikipedia In-the-news portal) to fix the gossip/marketing/stale-celeb noise on the homepage. | M1-M4 in. Per-source contribution to the rail will only fully materialise once PRD-025's entity_titles.tsv exists (currently dormant on prod). |
